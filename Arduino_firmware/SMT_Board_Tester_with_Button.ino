/* ======================================================================
 * SMT Board Tester – Enhanced Version with Physical Button Support
...
void handleCommand(const String& cmd) {
  ...
  if (command.equalsIgnoreCase("VERSION")) {
    sendResponse(ResponseType::OK, "VERSION:5.0.1");
    return;
  }
...
void setup() {
  ...
  Serial.println("Firmware: Enhanced Version 5.0.1 with Button Support");
